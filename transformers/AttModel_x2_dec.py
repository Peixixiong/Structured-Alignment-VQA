    ...
    def forward(self, vis_fea, vis_mask, vis_graph, q_fea, q_graph, q_mask, decMask, visGraph):
        ...
        for id in range(mask.size(0)):
            ...
            if decMask != False:
                ...
                non_zero_mask_id[non_zero_mask_id.nonzeor()] = 1
...
class AttModel(nn.Module):
    ...
    def forward(self, vis_fea, vis_mask, q_ipt, q_mask, q_graph, syb_ipt, syb_mask, syb_graph, vis_graph, decMask=True, visGraph=True):
