...
class GQADataset(data.Dataset):
    def __init__(self, split, opt, fea_tar_fn, q_tar_fn, g_tar_fn, topN, with_loc=True, with_gt_relation=False):
        #self, split, opt, fea_tar_fn, q_tar_fn, g_tar_fn, topN, with_loc = True, with_gt_relation = False
        #self, split, opt, fea_tar_fn, q_tar_fn, gt_graph_fn, topN, with_loc=True, with_gt_relation=False
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            nodes, edges, idx_of_obj = self.convert_graph(gt_graph)
